                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {[...Array(6)].map((_, index) => (
                        <div key={index} className="bg-white rounded-3xl shadow-lg overflow-hidden border border-gray-200 animate-pulse">
                            {/* Image Skeleton */}
                            <div className="h-56 bg-gradient-to-br from-yellow-200 to-yellow-300 relative">
                            ...
                            <div className="p-6">
                                ...
                                <div className="space-y-3 mb-5">
                                    <div className="w-36 h-8 bg-gray-100 rounded-lg"></div>
                                    <div className="w-28 h-4 bg-gray-200 rounded"></div>
                                </div>

                                {/* Buttons Skeleton */}
                                <div className="flex gap-3">
                                    <div className="flex-1 h-12 bg-gradient-to-r from-yellow-200 to-yellow-300 rounded-xl"></div>
